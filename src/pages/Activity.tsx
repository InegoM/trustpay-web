...
function filterEvents(events: ActivityEvent[], filter: string): ActivityEvent[] {
  ...
  if (filter === "Approvals")
    return events.filter(
      (e) => e.event === "milestone-approved" || e.event === "decision-recorded",
    );

  if (filter === "Evidence") return events.filter((e) => e.event === "evidence-submitted");

  if (filter === "Variations") return events.filter((e) => e.event === "variation-approved");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`${CARD} p-6`}>
        {filtered.length === 0 ? (
          <div className="text-center py-12 text-muted text-sm">No events match this filter.</div>
        ) : (
                      ...
                      <div className="flex items-start justify-between gap-4 flex-wrap">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mt-1.5 flex-wrap">
                            ...
                            {event.milestone && (
                              <>
                                <span className="text-xs text-edge" aria-hidden="true">
                                  ·
                                </span>
