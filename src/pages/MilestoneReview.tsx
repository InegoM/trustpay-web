import { PROJECT, MILESTONE_2_DATA, fmt } from "@/data/mock";
    ...
    return (
      <div className="w-12 h-12 rounded-xl bg-brand-light flex items-center justify-center flex-shrink-0" aria-hidden="true">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
          ...
          <path d="M2 15l5-4 4 3.5 3-2.5 6 5" stroke="#2B9B8E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </div>
    );
  }
  return (
    <div className="w-12 h-12 rounded-xl bg-danger-light flex items-center justify-center flex-shrink-0" aria-hidden="true">
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M6 2h7l5 5v13a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2z" stroke="#DC2626" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M13 2v5h5" stroke="#DC2626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-warn-light border border-warn/30 px-5 py-4 flex items-center gap-4">
        <div className="w-9 h-9 rounded-xl bg-warn/15 flex items-center justify-center flex-shrink-0" aria-hidden="true">
      ...
      <div className="grid grid-cols-3 gap-6 items-start">
        ...
        <div className="col-span-2 space-y-5">
          ...
          <div className={`${CARD} p-6`}>
            <h2 style={{ fontFamily: "var(--font-display)" }} className="text-base font-semibold text-ink mb-4">
              Submission details
            </h2>
            <div className="grid grid-cols-2 gap-x-8 gap-y-3">
              {[
                ...
                { label: "Agreement", value: `${PROJECT.agreementVersion}, accepted ${PROJECT.agreementAccepted}` },
          ...
          <div className={`${CARD} p-6`}>
            ...
            <p className="text-xs text-muted mb-3">
              The following criteria were agreed at the time the agreement was accepted ({PROJECT.agreementVersion}).
            </p>
            <ul className="space-y-2.5" aria-label="Acceptance criteria">
              {m.criteria?.map((c, i) => (
                <li key={i} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-edge flex items-center justify-center flex-shrink-0 mt-0.5" aria-hidden="true">
              ...
              {m.requiredEvidence?.map((r, i) => (
                <li key={i} className="flex items-center gap-3 py-1.5 px-3 rounded-xl bg-edge/40">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                    <rect x="1" y="1" width="12" height="12" rx="2" stroke="#7A7870" strokeWidth="1.2" />
                    <path d="M4 7h6M4 9.5h3" stroke="#7A7870" strokeWidth="1.2" strokeLinecap="round" />
                  </svg>
          ...
          <div className={`${CARD} p-6`}>
            <div className="flex items-center justify-between mb-4">
              <h2 style={{ fontFamily: "var(--font-display)" }} className="text-base font-semibold text-ink">
                Evidence submitted
              </h2>
        ...
        <div className="sticky top-0 space-y-4">
          ...
          <div className={`${CARD} p-5`}>
            <p className="text-xs text-muted uppercase tracking-wider font-medium mb-3">Milestone summary</p>
            <div className="space-y-2.5">
              {[
                ...
                { label: "Agreement", value: `${PROJECT.agreementVersion} &middot; ${PROJECT.agreementAccepted}` },
              ].map((row) => (
                <div key={row.label} className="flex justify-between gap-2 text-sm">
                  <span className="text-muted">{row.label}</span>
                  <span
                    style={row.bold ? { fontFamily: "var(--font-display)" } : {}}
                    className={`text-right ${row.bold ? "font-semibold text-ink text-base" : "font-medium text-ink"}`}
                  >
                    {row.label === "Agreement"
          ...
          <div className={`${CARD} p-5`}>
            <p className="text-xs text-muted uppercase tracking-wider font-medium mb-3">About your decision</p>
            <div className="space-y-3">
              <div className="flex gap-3">
                <div className="w-2 h-2 rounded-full bg-brand flex-shrink-0 mt-1.5" aria-hidden="true" />
                <div>
                  <p className="text-xs font-semibold text-ink">Approve</p>
                  <p className="text-xs text-muted mt-0.5 leading-snug">
                    Records that this milestone meets the agreed acceptance criteria. Any payment is handled externally.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="w-2 h-2 rounded-full bg-warn flex-shrink-0 mt-1.5" aria-hidden="true" />
                <div>
              ...
              <div className="flex gap-3">
                <div className="w-2 h-2 rounded-full bg-danger flex-shrink-0 mt-1.5" aria-hidden="true" />
                <div>
                  <p className="text-xs font-semibold text-ink">Raise dispute</p>
                  <p className="text-xs text-muted mt-0.5 leading-snug">
                    Records a formal disagreement, preserves all submitted evidence, and pauses the decision.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-2.5">
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <path d="M2.5 8L6 11.5L13.5 4" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              Approve milestone
            </button>
            <button
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <path d="M2 10V14h4L13 7a1.41 1.41 0 10-2-2L4 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              Request changes
            </button>
            <button
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <path d="M8 2L1.5 13.5h13L8 2z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
