    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className={`${CARD} p-6`}>
        ...
        <div className="space-y-3">
          {[
            ...
            { label: "Recorded", value: "27 August 2026, 3:42 PM GST" },
            { label: "Reference", value: "TP-CAF-M2-2026-0827" },
          ].map((row) => (
      ...
      <div className="rounded-2xl bg-brand-light border border-brand-mid p-5">
        <p className="text-sm text-ink leading-relaxed">
          TrustPay recorded your acceptance of <strong>Milestone {m.id}: {m.name}</strong>.
          The submitted evidence, acceptance criteria, and this decision are now permanently on record.
        ...
        <ul className="space-y-2.5">
          {[
            ...
            <li key={i} className="flex items-start gap-3 text-sm text-ink-dim">
              <div className="w-5 h-5 rounded-full bg-brand-light flex items-center justify-center flex-shrink-0 mt-0.5" aria-hidden="true">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                  <path d="M2 5L4 7L8 3" stroke="#2B9B8E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
      ...
      <p className="text-xs text-muted text-center">
        Reference: TP-CAF-M2-2026-0827 &middot; TrustPay records agreements, evidence, and decisions. It does not hold or transfer money.
      </p>
    </div>
  );
}
