        ...
        <div className={`${CARD} p-6`}>
          <div className="space-y-3">
            {[
              ...
              { label: "Recorded", value: "27 August 2026, 4:15 PM GST" },
              { label: "Next step", value: "Mediator site inspection" },
              { label: "Reference", value: "TP-CAF-M2-DSP-0827" },
            ].map((row) => (
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl bg-danger-light border border-danger/25 p-5 flex gap-4">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="flex-shrink-0 mt-0.5" aria-hidden="true">
          <path d="M10 2L1.5 17.5h17L10 2z" stroke="#DC2626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <div>
          ...
          <p className="text-sm text-ink-dim mt-1 leading-relaxed">
            Raising a dispute formally pauses the milestone decision. The agreement, submitted evidence,
            and all records are preserved. The next step may involve a mediator or site inspection.
      ...
      <div className={`${CARD} p-6 space-y-5`}>
        ...
        <div className="rounded-xl bg-edge/40 p-4 space-y-2">
          <p className="text-xs font-semibold text-ink uppercase tracking-wide">Consequences of raising a dispute</p>
          <ul className="space-y-1.5 text-xs text-ink-dim">
            ...
            <li className="flex items-start gap-2">
              <span className="text-muted mt-0.5">&#8250;</span>
              A mediator or site inspection may be required to resolve the dispute.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-muted mt-0.5">&#8250;</span>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={() => {
            if (disputeReason.trim()) setSubmitted(true);
          }}
          className="flex-1 px-5 py-3 bg-danger text-white text-sm font-semibold rounded-xl hover:bg-danger/90 active:scale-[0.99] transition-all focus-visible:ring-2 focus-visible:ring-danger focus-visible:ring-offset-2"
        >
          Record dispute
        </button>
      </div>
